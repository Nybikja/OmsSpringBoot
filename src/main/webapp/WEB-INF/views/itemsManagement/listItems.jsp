	...
	function processSearch() {
		...
		$.getJSON('productsAJAX.htm', data, function(response) {
			...
			$.each(records, function() {
				...
				newRow += "<td>" + this.description + "</td>";
				newRow += "<td>" + this.price + "</td>";
	...
	<div id="main">
		...
		<div id="site_content">
			<div id="content">
				<div id="list">
					<h2>
						This page is appointed for adding new and editing existing products.
					</h2>

					<a href="addItem.htm">Add Product </a>
					...
					<table id="table">
						<thead>
						<tr>
							<th><a href="${itemSort}?propertyName=name">Name </a></th>
							<th><a href="${itemSort}?propertyName=description">Description </a></th>
							<th><a href="${itemSort}?propertyName=price">Price </a></th>
							<th>Edit</th>
							<th>Delete</th>
						</tr>
						</thead>
						...
						<c:forEach items="${products}" var="product">
							<tr>
								...
								<td>${product.price}</td>
								<td><a href="editItem.htm?productID=${product.id}">Edit </a>
								<td><a href='javascript:deleteItem("${product.id}");'>Delete </a></td>
							</tr>
						</c:forEach>
					</table>
					...
					<h5>
						<a href="reportItems.htm">create report
						</a>
					</h5>
				</div>
			</div>
