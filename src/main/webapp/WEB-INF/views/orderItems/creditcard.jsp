	...
	<form id="form2" name="form2" method="post" action="">
		<fieldset style="height: 306px">
			...
			<table width="320" height="178" border="0">
				...
				<tr>
					<td><strong>Credit Card Number <span
				...
				<tr>
					<td><strong>CVV2 (<a
							href="#"
							onClick="MyWindow=window.open('resources/whatiscvv2.html','MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=350,height=500'); return false;">What is this?
				...
				<tr>
					<td><strong>Issue Number <br>
						card.maestroOnly = (Maestro Only) </strong>
					</td>
				...
				<tr>
					<td></td>
					<td><span style="color: red;">* card.mandatory = fields are mandatory </span>
					</td>
				</tr>
			</table>
		</fieldset>
